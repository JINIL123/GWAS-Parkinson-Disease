...
cc_map <-read.table("K:/DAV/parkisons_project/cc_map/chr1.map", sep="\t",stringsAsFactors = F)

cc_pre <-read.table("K:/DAV/parkisons_project/cc_pre/cc_chr1.pre", sep=" ",stringsAsFactors = F)

pd_map <-read.table("K:/DAV/parkisons_project/pd_map/chr1.map", sep="\t",stringsAsFactors = F)

pd_pre <-read.table("K:/DAV/pparkisons_project/pd_pre/chr1.pre", sep=" ",stringsAsFactors = F)
